...
const STRINGS = {
  ...
  lang_name_en: { en: 'English', zh: '英文', ja: '英語', ko: '영어', es: 'inglés' },
  lang_name_zh: { en: 'Chinese', zh: '中文', ja: '中国語', ko: '중국어', es: 'chino' },
  lang_name_ja: { en: 'Japanese', zh: '日文', ja: '日本語', ko: '일본어', es: 'japonés' },
  lang_name_ko: { en: 'Korean', zh: '韩文', ja: '韓国語', ko: '한국어', es: 'coreano' },
  lang_name_es: { en: 'Spanish', zh: '西文', ja: 'スペイン語', ko: '스페인어', es: 'español' },
  writing_banner: {
    en: 'On Deadline',
    zh: '截稿在即',
    ja: '締切迫る',
  ...
  writing_1: {
    en: 'querying the wire…',
    zh: '正在打电报…',
    ja: '電報を打ってる…',
    ko: '전보 치는 중…',
    es: 'consultando el telégrafo…',
  },
  writing_2: {
    en: 'shaking down the witness…',
    zh: '审讯证人…',
    ja: '目撃者を尋問中…',
    ko: '증인 추궁 중…',
    es: 'interrogando al testigo…',
  },
  writing_3: {
    en: 'pulling the case file…',
    zh: '调取案宗…',
    ja: '事件簿を引っぱり出す…',
    ko: '사건 파일 꺼내는 중…',
    es: 'sacando el expediente…',
  },
  writing_4: {
    en: 'inking the draft…',
    zh: '誊写草稿…',
    ja: '下書きを清書…',
    ko: '초고 정서 중…',
    es: 'pasando a limpio el borrador…',
  },
  writing_5: {
    en: 'chasing the lead…',
    zh: '追查线索…',
